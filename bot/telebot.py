...
env_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'me-cli', '.env')
...
class MayugoroXLBot:
    ...
    def __init__(self):
        ...
        # Path to banner image (banner.jpg ada di root project)
        self.banner_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'banner.jpg')
